...
function Notificacion({listaNotificacion}) {
    ...
    const actualizar=async(id)=>{
      await actualizarNotificacion(id)
    }
    return (
        ...
        <div className="list-group">
          <div className="lg">
            {listaNotificacion.map((notificacion,index)=>(
                  <a href="perfil" className="list-group-item list-group-item-action flex-column align-items-start" onClick={()=>actualizar(notificacion.idNotificacion)}>
